...
<head>
<title>Persoajes Rick & Morty</title>
<meta charset="utf-8">
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading">Personajes</header>
          <ul class="nospace clear">
            @foreach($personajes as $personaje)
              <li class="one_quarter">
                <figure><a class="imgover" href="#"><img src="{{$personaje['imagen']}}" alt=""></a>
                  <figcaption><strong>{{$personaje['nombre']}}</strong> <em>Job Title Here</em></figcaption>
                </figure>
              </li>
            @endforeach
          </ul>
